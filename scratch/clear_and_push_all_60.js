...
console.log('--- Step 1: Clearing Android emulator SMS inbox ---');
try {
  execSync('adb shell content delete --uri content://sms');
} catch (e) {}

console.log('--- Step 2: Delivering all 60 complete SMS alerts via ADB ---');
let sent = 0;
...
console.log(`Successfully sent ${sent} / ${corpus.length} complete SMS alerts!`);
